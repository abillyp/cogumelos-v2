...
class FormulacaoServiceTest {
    ...
    void criar_deveCalcularCnEPersistir() {
        ...
        FormulacaoRequest req = new FormulacaoRequest("esp-1", "Shimeji A3", List.of(item), 70.5, 2.0, 20.0);
    ...
    void criar_insumoDeOutroTenant_deveLancar404() {
        ...
        FormulacaoRequest req = new FormulacaoRequest("esp-1", "Teste", List.of(item), 70.5, 2.0, 20.0);
